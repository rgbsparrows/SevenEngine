...
IF EXIST ..\Binaries\DotNET\UnrealBuildTool.exe (
        ..\Binaries\DotNET\UnrealBuildTool.exe %* -DEPLOY
		popd
	...
	ECHO UnrealBuildTool.exe not found in ..\Binaries\DotNET\UnrealBuildTool.exe 
	popd
	EXIT /B 999
)
