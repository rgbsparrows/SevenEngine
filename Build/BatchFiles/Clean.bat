...
rem ## Execute UBT
:ReadyToClean
if not exist ..\Binaries\DotNET\UnrealBuildTool.exe goto Error_UBTMissing
..\Binaries\DotNET\UnrealBuildTool.exe %* -clean
goto Exit
...
:Error_UBTMissing
echo Clean ERROR: UnrealBuildTool.exe not found in ..\Binaries\DotNET\UnrealBuildTool.exe 
pause
goto Exit
