...
namespace WindowsPlatformApiWarp_Impl
{
	...
	bool RegisterClass_WindowsImpl(uint32_t _style, void* _wndProc, void* _instance, void* _icon, void* _cursor, void* _background, std::wstring_view _className, void* _smallIcon, uint32_t* _errorCode);
	bool GetClassInfo_WindowsImpl(void* _instance, std::wstring_view _className, uint32_t* _style, void** _wndProc, void** _icon, void** _cursor, void** _background, void** _smallIcon, uint32_t* _errorCode);
	bool UnregisterClass_WindowsImpl(std::wstring_view _className, void* _instance, uint32_t* _errorCode);
	void* CreateWindow_WindowsImpl(std::wstring_view _className, std::wstring_view _windowName, uint64_t _style, int32_t _x, int32_t _y, int32_t _width, int32_t _height, void* _wndParent, void* _menu, void* _instance, void* _param, uint32_t* _errorCode);
