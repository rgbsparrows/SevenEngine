...
namespace WindowsPlatformApiWarp_Impl
{
	...
	bool RegisterClass_WindowsImpl(uint32_t _style, void* _wndProc, void* _instance, void* _icon, void* _cursor, void* _background, std::wstring_view _menuName, std::wstring_view _className, void* _smallIcon, uint32_t* _errorCode) noexcept;
