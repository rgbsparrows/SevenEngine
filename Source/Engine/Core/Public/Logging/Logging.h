...
inline void CombinString() 
{
}

template <typename T>
DEPRECATED_WHEN_FMT_LIBRARY_AVAILABLE("")
std::wstring CombinString(const T& t)
{
...
DEPRECATED_WHEN_FMT_LIBRARY_AVAILABLE("")
std::wstring CombinString(const First& first, const Rest&... rest) {
	return std::wstring() + first + CombinString(rest...);
}

template<typename... _argts>
DEPRECATED_WHEN_SE_LOG_AVAILABLE("")
void LogInfo(_argts&&... _args)
{
