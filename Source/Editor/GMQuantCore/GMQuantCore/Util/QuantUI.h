...
void ImPlotDrawColorRange(const std::vector<ImColor>& _valueList, float _thickness = 5.f);
void ImPlotDrawColorRange(SPlotGetColorFunc&& _getColorFunc, size_t _begin, size_t _end, float _thickness = 5.f);
