...
namespace UnrealBuildTool
{
    ...
    abstract class UEBuildModule
    {
        ...
        /// <summary>
        /// The name of the package to which the module belongs.
        /// </summary>
        ...
        /// <param name="InPackageName">The name of the package to which the module belongs</param>
        ...
        public UEBuildModule(string InName, string InPackageName, DirectoryReference InModuleDirectory, ModuleRules InRules, FileReference InRulesFile, List<RuntimeDependency> InRuntimeDependencies)
        {
            Name = InName;
            ...
            )
        {
            ...
            Definitions.Add("MODULE_NAME=" + Name);
            Definitions.Add("PACKAGE_NAME=" + PackageName);
