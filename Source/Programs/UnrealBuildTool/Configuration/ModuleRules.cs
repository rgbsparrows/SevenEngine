...
namespace UnrealBuildTool
{
    ...
    public class ModuleRules
    {
        ...
        public enum CodeOptimization
        {
            ...
            /// <summary>
            /// Code should only be optimized in shipping builds (not in Debug, Development)
            /// </summary>
        ...
        /// <summary>
        /// Whether this module should be treated as an engine module (eg. using engine definitions, PCHs, etc...).
