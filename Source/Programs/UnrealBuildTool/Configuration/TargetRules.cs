...
#pragma warning restore CS1591
        ...
        public TargetRules(TargetInfo Target)
        {
            ...
            {
                ProjectDefinitions.Add(String.Format("IMPLEMENT_ENCRYPTION_KEY_REGISTRATION()=SE_REGISTER_ENCRYPTION_KEY({0})", FormatHexBytes(CryptoSettings.EncryptionKey.Key)));
            }
            else
            {
            ...
            {
                ProjectDefinitions.Add(String.Format("IMPLEMENT_SIGNING_KEY_REGISTRATION()=SE_REGISTER_SIGNING_KEY(SE_LIST_ARGUMENT({0}), SE_LIST_ARGUMENT({1}))", FormatHexBytes(CryptoSettings.SigningKey.PublicKey.Exponent), FormatHexBytes(CryptoSettings.SigningKey.PublicKey.Modulus)));
            }
            else
            {
        ...
        internal void SetOverridesForTargetType()
        {
            if (Type == global::UnrealBuildTool.TargetType.Game)
            {
                ...
                GlobalDefinitions.Add("SE_GAME=1");
            }
            ...
            else if (Type == global::UnrealBuildTool.TargetType.Editor)
            {
                ...
                GlobalDefinitions.Add("SE_EDITOR=1");
            }
            else if (Type == global::UnrealBuildTool.TargetType.Server)
            {
                ...
                GlobalDefinitions.Add("SE_SERVER=1");
