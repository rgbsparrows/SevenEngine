...
namespace UnrealBuildTool
{
    ...
    class VCProjectFileGenerator : ProjectFileGenerator
    {
            ...
            : base(InOnlyGameProject)
        {
            ...
            else if (InOverrideCompiler == WindowsCompiler.VisualStudio2019)
            {
        ...
        protected override bool WriteMasterProjectFile(ProjectFile UBTProject)
        {
            ...
            if (ProjectFileFormat == VCProjectFileFormat.VisualStudio2019)
            {
                VCSolutionFileContent.Append(
                    ...
                    "# Visual Studio 16" + ProjectFileGenerator.NewLine +
                    "VisualStudioVersion = 16.0.29519.181" + ProjectFileGenerator.NewLine +
            ...
            if (bSuccess && bWriteSolutionOptionFile)
            {
                ...
                if (!FileReference.Exists(SolutionOptionsFileName))
                {
                    ...
                    {
                        BuildSolutionExplorerState_VS2017Or2019(RootFolder, "", ExplorerState, DefaultProject);
                    }
                    else
                    {
        ...
        static void BuildSolutionExplorerState_VS2017Or2019(MasterProjectFolder Folder, string Suffix, VCSolutionExplorerState ExplorerState, ProjectFile DefaultProject)
        {
            ...
            foreach (MasterProjectFolder SubFolder in Folder.SubFolders)
            {
                ...
                BuildSolutionExplorerState_VS2017Or2019(SubFolder, ";" + SubFolderName, ExplorerState, DefaultProject);
            }
        }
