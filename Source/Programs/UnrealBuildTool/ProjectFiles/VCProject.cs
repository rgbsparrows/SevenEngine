                ...
                foreach (AliasedFile AliasedFile in LocalAliasedFiles)
                {
                    ...
                    if (!string.IsNullOrEmpty(PCHFileName))
                    {
                        VCProjectFileContent.Append(
                            ...
                            "			<AdditionalOptions>$(AdditionalOptions) /Yu" + PCHFileName + ProjectFileGenerator.NewLine +
        ...
        private void WriteConfiguration(string ProjectName, ProjectConfigAndTargetCombination Combination, StringBuilder VCProjectFileContent, StringBuilder VCUserFileContent)
        {
...

            {
                ...
                else
                {
                    ...
                    if (Configuration != TargetRulesObject.UndecoratedConfiguration && TargetRulesObject.ProjectFile != null)
                    {
                    ...
                    string cppStandardArgument = "";
                    switch (TargetRulesObject.CppStandard)
                    {
                        case CppStandardVersion.Default:
                            break;
                        case CppStandardVersion.Cpp14:
                            cppStandardArgument = "/std:c++14";
                            break;
                        case CppStandardVersion.Cpp17:
                            cppStandardArgument = "/std:c++17";
                            break;
                        case CppStandardVersion.Latest:
                            cppStandardArgument = "/std:c++latest";
                            break;
                    }
                    ...
                    VCProjectFileContent.Append("		<AdditionalOptions>");
                    VCProjectFileContent.Append(cppStandardArgument);
                    VCProjectFileContent.Append("</AdditionalOptions>" + ProjectFileGenerator.NewLine);
                ...
                if (VCUserFileContent != null && Combination.ProjectTarget != null)
                {
                    ...
                    if ((Platform == UnrealTargetPlatform.Win32) || (Platform == UnrealTargetPlatform.Win64))
                    {
                        ...
                        if (TargetRulesObject.Type != TargetType.Game)
                        {
                            ...
                            else if (TargetRulesObject.Type == TargetType.Editor && ProjectName != "Seven")
                            {
