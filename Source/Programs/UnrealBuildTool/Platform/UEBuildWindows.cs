...
namespace UnrealBuildTool
{
    ...
    public class WindowsTargetRules
    {
        ...
        {
            get { return Compiler == WindowsCompiler.VisualStudio2015 || Compiler == WindowsCompiler.VisualStudio2017 || Compiler == WindowsCompiler.VisualStudio2019; }
        }
        ...
        public string GetVisualStudioCompilerVersionName()
        {
            switch (Compiler)
            {
                ...
                case WindowsCompiler.VisualStudio2019:
                    return "2015"; // VS2019 is backwards compatible with VS2015 compiler
...
#pragma warning restore CS1591
    ...
    class WindowsPlatform : UEBuildPlatform
    {
            ...
            if (!CachedVCToolChainDirs.TryGetValue(Compiler, out ToolChainVersionToDir))
            {
                ...
                if (BuildHostPlatform.Current.Platform == UnrealTargetPlatform.Win64 || BuildHostPlatform.Current.Platform == UnrealTargetPlatform.Win32)
                {
                    ...
                    else if (Compiler == WindowsCompiler.VisualStudio2017 || Compiler == WindowsCompiler.VisualStudio2019)
                    {
                        ...
                        {
                            DirectoryReference ToolChainBaseDir = DirectoryReference.Combine(PlatformDir, "Win64", vsStr);
                            if (DirectoryReference.Exists(ToolChainBaseDir))
                            {
                                foreach (DirectoryReference ToolChainDir in DirectoryReference.EnumerateDirectories(ToolChainBaseDir))
                                {
        ...
        /// <summary>
        /// Checks if the given directory contains a valid Visual Studio 2017 or 2019 toolchain
        /// </summary>
        /// <param name="ToolChainDir">Directory to check</param>
        /// <returns>True if the given directory is valid</returns>
        ...
        public static bool TryGetMsBuildPath(out FileReference OutLocation)
        {
            ...
            List<DirectoryReference> Vs2019InstallDirs = WindowsPlatform.FindVSInstallDirs(WindowsCompiler.VisualStudio2019);
            foreach (DirectoryReference InstallDir in Vs2019InstallDirs)
            {
            ...
            List<DirectoryReference> Vs2017InstallDirs = WindowsPlatform.FindVSInstallDirs(WindowsCompiler.VisualStudio2017);
            foreach (DirectoryReference InstallDir in Vs2017InstallDirs)
            {
        ...
        public override void SetUpEnvironment(ReadOnlyTargetRules Target, CppCompileEnvironment CompileEnvironment, LinkEnvironment LinkEnvironment)
        {
            ...
            if (Target.Type == TargetType.Game || Target.Type == TargetType.Client || Target.Type == TargetType.Server)
            {
        ...
        public override void SetUpConfigurationEnvironment(ReadOnlyTargetRules Target, CppCompileEnvironment GlobalCompileEnvironment, LinkEnvironment GlobalLinkEnvironment)
        {
            ...
            switch (CheckConfig)
            {
                ...
                case UnrealTargetConfiguration.Debug:
                    GlobalCompileEnvironment.Definitions.Add("SE_BUILD_DEBUG=1");
                    break;
                case UnrealTargetConfiguration.Development:
                    GlobalCompileEnvironment.Definitions.Add("SE_BUILD_DEVELOPMENT=1");
                    break;
                case UnrealTargetConfiguration.Shipping:
                    GlobalCompileEnvironment.Definitions.Add("SE_BUILD_SHIPPING=1");
                    break;
                case UnrealTargetConfiguration.Test:
                    GlobalCompileEnvironment.Definitions.Add("SE_BUILD_TEST=1");
                    break;
            }
